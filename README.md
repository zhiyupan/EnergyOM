...
You can customize EnergyOM along several dimensions.

- New ontologies or schemas  
  - add readers in `Data_Reading`  
  - add preprocessing functions in `Data_Processing`  

- New matching signals  
  - implement lexical or structural matchers in `Data_Matching`  
  - wrap embedding models or other encoders under `Model`  

- New experiments  
  - create a new script under `energy_domain_experiment` or `Experiment`  
  - follow the layout of `conference_experiment.py` when wiring together reading, matching, and evaluation  

Keeping this structure consistent helps with reproducibility and comparison across experiments.

---

## Typical applications

EnergyOM is intended for tasks such as

- aligning different building or grid information models  
- mapping device or sensor schemas to a common reference ontology  
- matching KPI and measurement definitions across platforms  
- producing reliable mappings that feed into energy analytics and control pipelines  

---

## License

Add the chosen license for this project here, for example

```text
MIT License
```

or another license that you prefer.

---

## Contact and citation

If you use this repository in academic work, please add a citation to the corresponding publication on ontology matching in the energy domain and reference this repository in your paper or report.
