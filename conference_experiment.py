...
cmt_path = r".\Data/ontology/cmt.xml"
conference_path = r".\Data/ontology/conference.xml"
confof_path = r".\Data/ontology/confof.xml"
edas_path = r".\Data/ontology/edas.xml"
ekaw_path = r".\Data/ontology/ekaw.xml"
iasted_path = r".\Data/ontology/iasted.xml"
sigkdd_path = r".\Data/ontology/sigkdd.xml"

# set path of answer
cmt_conference_answer_path = r"./Data/answer/cmt_conference_answer.xlsx"
cmt_confof_answer_path = r"./Data/answer/cmt_confof_answer.xlsx"
cmt_edas_answer_path = r"./Data/answer/cmt_edas_answer.xlsx"
cmt_ekaw_answer_path = r"./Data/answer/cmt_ekaw_answer.xlsx"
cmt_iasted_answer_path = r"./Data/answer/cmt_iasted_answer.xlsx"
cmt_sigkdd_answer_path = r"./Data/answer/cmt_sigkdd_answer.xlsx"

conference_confof_answer_path = r"./Data/answer/conference_confof_answer.xlsx"
conference_edas_answer_path = r"./Data/answer/conference_edas_answer.xlsx"
conference_ekaw_answer_path = r"./Data/answer/conference_ekaw_answer.xlsx"
conference_iasted_answer_path = r"./Data/answer/conference_iasted_answer.xlsx"
conference_sigkdd_answer_path = r"./Data/answer/conference_sigkdd_answer.xlsx"

confof_edas_answer_path = r"./Data/answer/confof_edas_answer.xlsx"
confof_ekaw_answer_path = r"./Data/answer/confof_ekaw_answer.xlsx"
confof_iasted_answer_path = r"./Data/answer/confof_iasted_answer.xlsx"
confof_sigkdd_answer_path = r"./Data/answer/confof_sigkdd_answer.xlsx"

edas_ekaw_answer_path = r"./Data/answer/edas_ekaw_answer.xlsx"
edas_iasted_answer_path = r"./Data/answer/edas_iasted_answer.xlsx"
edas_sigkdd_answer_path = r"./Data/answer/edas_sigkdd_answer.xlsx"

ekaw_iasted_answer_path = r"./Data/answer/ekaw_iasted_answer.xlsx"
ekaw_sigkdd_answer_path = r"./Data/answer/ekaw_sigkdd_answer.xlsx"

iasted_sigkdd_answer_path = r"./Data/answer/iasted_sigkdd_answer.xlsx"
...
def experiment_1():
    ...
    experiment_1_save_folder = f"./Data/results/experiment_1_results"
...
def experiment_2():
    ...
    experiment_2_save_folder = f"./Data/results/experiment_2_results"
...
def experiment_3():
    ...
    experiment_3_save_folder = f"./Data/results/experiment_3_results"
...
def experiment_4():
    ...
    experiment_4_save_folder = f"./Data/results/experiment_4_results"
    os.makedirs(experiment_4_save_folder, exist_ok=True)

    for src, tgt in combinations(all_names, 2):
        pair_name = f"{src}_{tgt}"
        merge_folder = Path(f"./Data/results/experiment_3_results/{pair_name}/merged_result")
...
def experiment_5():
    ...
    experiment_5_save_folder = f"./Data/results/experiment_5_results"
    os.makedirs(experiment_5_save_folder, exist_ok=True)

    for src, tgt in combinations(all_names, 2):
        pair_name = f"{src}_{tgt}"
        merge_folder = Path(f"./Data/results/experiment_2_results/{pair_name}/merged_result")
        for p in merge_folder.iterdir():
            d = excel_to_dict(p)
            matches = deepseek_model.test_for_equivalence(d)
...
def experiment_6():
    ...
    experiment_6_save_folder = f"./Data/results/experiment_6_results"
    os.makedirs(experiment_6_save_folder, exist_ok=True)
    results_path_6 = {}
    print("=====================================================================")
    print("====================The Beginning of Experiment 6====================")
    print("=====================================================================")

    for src, tgt in combinations(all_names, 2):
        print(f"***********Starting matching between {src} and {tgt}***********")
        pair_name = f"{src}_{tgt}"
        results_path_6[pair_name] = {}
        ...
        class_result_path = class_matcher.class_matching_results(name_based=True, hierarchy_based=True,
                                                                 comment_based=False,
                                                                 threshold=class_threshold, top_k=1)
        results_path_6[pair_name]["class"] = class_result_path
        ...
        data_property_result_path = data_property_matcher.property_matching_results(name_based=True,
                                                                                    ...
                                                                                    threshold=property_threshold,
                                                                                    top_k=1)
        results_path_6[pair_name]["data_property"] = data_property_result_path

        results_path_6[pair_name]["object_property"] = object_property_result_path
        merged_result_folder = save_folder + "/merged_result"
        results_path_6[pair_name]["merged"] = merged_result_folder
        merged_result_path = merge_class_property(results_path_6[pair_name]["class"],
                                                  results_path_6[pair_name]["object_property"],
                                                  results_path_6[pair_name]["data_property"],
                                                  results_path_6[pair_name]["merged"])
...
def experiment_7():
    ...
    experiment_7_save_folder = f"./Data/results/experiment_7_results"
    ...
    for src, tgt in combinations(all_names, 2):
        ...
        original_merged_result_path = f"./Data/results/experiment_2_results/{src}_{tgt}/merged_result/merged.xlsx"
...
def experiment_8():
    # Set Path of 1.Experiment
    experiment_8_save_folder = f"./Data/results/experiment_8_results"
    ...
    for src, tgt in combinations(all_names, 2):
        ...
        reversed_result_path = merged_result_folder + "/reversed.xlsx"
        exchange_two_columns(merged_result_path, reversed_result_path)
        original_merged_result_path = f"./Data/results/experiment_1_results/{src}_{tgt}/merged_result/merged.xlsx"
        combined_result_path = merged_result_folder + "/combined.xlsx"
        combine_two_files(original_merged_result_path, reversed_result_path, combined_result_path)
...
def experiment_9():
    # Set Path of 9.Experiment
    experiment_9_save_folder = f"./Data/results/experiment_9_results"
    os.makedirs(experiment_9_save_folder, exist_ok=True)

    for src, tgt in combinations(all_names, 2):
        pair_name = f"{src}_{tgt}"
        merge_folder = Path(f"./Data/results/experiment_8_results/{pair_name}/merged_result")
        target_file = merge_folder / "combined.xlsx"
        if target_file.exists():
            d = excel_to_dict(target_file)
            matches = deepseek_model.test_for_equivalence(d)
            matching_result_path = experiment_9_save_folder + f"/{pair_name}/result/result.xlsx"
            dict_to_excel(matches, matching_result_path)
...
def experiment_10():
    ...
    experiment_10_save_folder = f"./Data/results/experiment_10_results"
    os.makedirs(experiment_10_save_folder, exist_ok=True)

    for src, tgt in combinations(all_names, 2):
        pair_name = f"{src}_{tgt}"
        merge_folder = Path(f"./Data/results/experiment_7_results/{pair_name}/merged_result/combined.xlsx")
